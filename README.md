# Telegram Bot для пересылки фото и видео в группу.

Бот для автоматического пересылки фото и видео в групповой чат с подписью: 🔩 "Сборка/Отчет от <имя монтажника в ТГ>⚒️".
